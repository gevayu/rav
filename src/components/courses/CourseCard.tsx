...
export function CourseCard({ course }: CourseCardProps) {
  ...
  return (
    <a
      ...
      className="group relative flex h-full flex-col overflow-hidden rounded-[28px] bg-white p-1.5 ring-1 ring-[color:var(--color-ink)]/8 transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-1 hover:ring-[color:var(--color-bronze)]/55 hover:shadow-[0_32px_60px_-30px_rgba(28,28,30,0.22)]">
      <div className="relative flex h-full flex-col rounded-[calc(28px-0.375rem)] bg-[color:var(--color-paper-soft)] p-7 shadow-[inset_0_1px_0_rgba(255,255,255,0.9)]">
        ...
        <div className="mt-6 flex items-end justify-between border-t border-[color:var(--color-ink)]/8 pt-5">
          ...
          <span className="group/cta inline-flex items-center gap-2 text-[13px] font-medium text-[color:var(--color-bronze-ink)]">
            לפרטי הקורס
            <ArrowLeft
