...
// Curated list of 27 partner logos — see public/images/partners/v2/.
const BASE_PARTNERS: Partner[] = Array.from({ length: 27 }, (_, i) => {
  const num = String(i + 1).padStart(2, "0");
  return { name: `שותף ${num}`, file: `v2/partner-${num}.png` };
});
