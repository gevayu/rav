      ...
      <div className="mx-auto max-w-[1240px] px-6 sm:px-10">
        <Reveal>
          <SectionHeading
            ...
            lede="לכל תחום - ראש תחום אחד, מומחה אמיתי מהשטח. אצלנו לומדים איך ליישם Ai דרך דוגמאות מהיומיום המקצועי שלך, מקרי בוחן אמיתיים מהתעשייה"
          />
        </Reveal>

        <ul className="mt-20 grid grid-cols-2 gap-5 md:grid-cols-4">
              ...
              >
                {sector.stripImageUrl ? (
                  <div className="relative h-20 w-full overflow-hidden">
                    ...
                    <div
                      aria-hidden="true"
                      className={`absolute inset-0 bg-gradient-to-l ${sector.gradient} opacity-60 mix-blend-multiply`}
                    />
                    <div
                      aria-hidden="true"
                      className="absolute inset-x-0 bottom-0 h-px bg-[color:var(--color-bronze)]/40"
                    />
                  </div>
                ) : (
