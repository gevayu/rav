        ...
        <section className="relative bg-white py-20 sm:py-24">
          <div className="mx-auto max-w-[860px] px-6 sm:px-10">
            ...
            <p className="mt-6 text-[16px] leading-relaxed text-[color:var(--color-ink-muted)]">
              מייסדי המרכז הם פיני מכלוף וגל גנוט, שניהם מגיעים עם ניסיון
              עשיר בתחומי ההדרכה והבינה המלאכותית ומובילים יחד גם את קבוצת
              &apos;אנליזה - המרכז הישראלי להכשרות טכנולוגיות&apos;.
            </p>
